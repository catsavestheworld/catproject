...
public class PlacementScript : MonoBehaviour
{
    ...
    void SettingPos()
    {
        ...
        furniturePos.Add(new Vector3(22.93f, -0.4f, 0));//5
        ...
        freePos_unlock.Add(new Vector3(-0.8f, 0f, 0));
        ...
        freePos_unlock.Add(new Vector3(26.25f, -0.3f, 0));
        ...
        freePos_lock.Add(new Vector3(-0.8f, 0f, 0));
        freePos_lock.Add(new Vector3(-8.7f, 0f, 0));
    }
